...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230911_alphawaytechnologyjointstock_833d2e5b511b9e864047_20230915031012_archive.zip';
        const ARCHIVE_SIZE       = '839694';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '833d2e5-15031012';
        const SECONDARY_PACKAGE_HASH = 'a5594ed-15031012';
