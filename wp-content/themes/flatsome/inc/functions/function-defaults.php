...
if(!function_exists('flatsome_defaults')){
  function flatsome_defaults($option) {
    $df = array(
      ...
      'type_headings' => array('font-family'=> 'Arial, Helvetica, sans-serif','variant' => '700'),
      'type_texts' => array('font-family'=> 'Arial, Helvetica, sans-serif','variant' => '400'),
      'type_nav' => array('font-family'=> 'Arial, Helvetica, sans-serif','variant' => '700'),
      ...
      'blog_show_excerpt' => 1,
      'wc_account_links' => 1,
      'footer_left_text' => 'Copyright [ux_current_year] &copy; <strong></strong>', // Sanitaize
